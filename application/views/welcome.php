<div class="page-container">
	<p class="f-20 text-success">欢迎使用ERP管理系统 <span class="f-14">v1.0</span></p>
	<p>登录次数：18 </p>
...
<footer class="footer mt-20">
	<div class="container">
		<!-- <p>感谢jQuery、layer、laypage、Validform、UEditor、My97DatePicker、iconfont、Datatables、WebUploaded、icheck、highcharts、bootstrap-Switch<br> -->
			Copyright &copy; ERP管理系统 All Rights Reserved.<br>
			本ERP系统由<a href="http://hushankj.cn" target="_blank" title="华杉科技">华杉科技</a>开发</p>
	</div>
</footer>
