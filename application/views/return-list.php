			...
			<tbody>
				<?php foreach ($data as $k => $v): ?>
					<tr class="text-c">
						...
						<!-- <td>6000.00</td> -->
						<td class="td-status"><span style="font-weight: normal;" class="label label-success radius">退回待申请</span></td>
						<td class="f-14 td-manage">
							<button style="text-decoration:none" onClick="order_apply(<?php echo $v['order_id'] ?>)" class="btn btn-secondary radius size-MINI" href="javascript:;" title="申请审核">申</button>
